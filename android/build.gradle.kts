...
// Add a configuration to exclude firebase-iid
configurations.all {
    resolutionStrategy {
...
dependencies {
    ...
    // Explicitly declare firebase-messaging and exclude firebase-iid
    implementation("com.google.firebase:firebase-messaging:24.1.0") {
        exclude(group = "com.google.firebase", module = "firebase-iid")
    }
    
    // Make sure other Firebase dependencies also exclude firebase-iid
